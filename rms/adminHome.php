...
<body>
    ...
    <nav class="navbar" style="background: #EC6509;">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <!-- Centered Title -->
            <span class="mx-auto fs-5 fw-bold text-white d-flex align-items-center">
                
                <span>Admin</span> <!-- Text -->
            </span>
        ...
        <div class="row mt-3 ms-2">
            <div class="row justify-content-center ">
                ...
                <div class="col-6 col-md-3 d-flex justify-content-center">
                    <a href="addUser.php" class="btn-dashboard text-decoration-none img-fluid">
                        <img src="image/add_user.png" alt="add_user">
                        <span>Add User</span>
                    </a>
                </div>
                <div class="col-6 col-md-3 d-flex justify-content-center">
                    <a href="userList.php" class="btn-dashboard text-decoration-none">
                        <img src="image/user_list.png" alt="user_list">
                        <span>User List</span>
                    </a>
                </div>
